...
train_dataset = datasets.CIFAR10(root='./data/CIFAR10', train=True, download  =True, transform=transforms.ToTensor())
...
for epoch in range(EPOCHS):
    ...
    print(f"\n[EPOCH: {epoch+1}], \tTrain Loss: {train_avg_loss:.4f}, \tTrain Accuracy: {train_avg_accuracy:.2f}%, \tVal Loss: {val_avg_loss:.4f}, \tVal Accuracy: {val_avg_accuracy:.2f}%\n")